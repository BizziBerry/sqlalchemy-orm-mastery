...
![Alembic настроен](screenshots/3_alembic_migration.jpg)
...
![Паттерн **Repository** для модели `Book` реализован](screenshots/4.jpg)
...
![Логирование SQL-запросов](screenshots/5_log.jpg)
### 🏠  Анализ стратегий загрузки
![Анализ стратегий загрузки](screenshots/5_an.jpg)
### 🏠  SQLAlchemy Core для сложных запросов
![SQLAlchemy Core для сложных запросов](screenshots/5_SQLAlchemy_Core.jpg).
### 🏠  Совместное использование ORM и Core
![Совместное использование ORM и Core](screenshots/5_SQLAlchemy_Core.jpg)
