...
https://img.shields.io/badge/Performance-Optimized-ffd700.svg
   ...
   [🚀 Функциональность](#-функциональность) •[🛠 Технологии](#-технологии) • [📸 Демонстрация](#-демонстрация) • [🛠 Установка и запуск](#-установка-и-запуск)• [👤 Тестовые пользователи](#-установка-и-запуск) 

</div>

## 🎯 Обзор выполнения
Все задачи успешно выполнены. Ниже представлен детальный отчет по каждой задаче с выводами и доказательствами выполнения.
...
![Созданы связанные модели Author и Book](screenshots/1_Author_Book.jpg)

### 🏠 Ленивая и жадная загрузка
![Ленивая и жадная загрузка](screenshots/1_lazy_Eager.jpg)

### 🏠 Сравнение загрузок
![Сравнение загрузок](screenshots/1_compare.jpg)
...
![Транзакции и откаты изменений](screenshots/2.jpg)
...
![Alembic настроен](3_alembic_migration.jpg)

### 🏠 Изменения структуры таблицы выполнены:+ price (FLOAT) - created_at (DATETIME)
![+ price (FLOAT) - created_at (DATETIME)](3_float_datetime.jpg)
...
![Паттерн **Repository** для модели `Book` реализован](4.jpg)
...
![Логирование SQL-запросов](5_log.jpg)
### 🏠  Анализ стратегий загрузки
![Анализ стратегий загрузки](5_an.jpg)
### 🏠  SQLAlchemy Core для сложных запросов
![SQLAlchemy Core для сложных запросов](5_SQLAlchemy Core.jpg)
### 🏠  Совместное использование ORM и Core
![Совместное использование ORM и Core](5_ORM_Core.jpg)
